...
export const profile = {
  ...
  about: {
      fr: "Arrivé au machine learning par le reinforcement learning — sur lequel j'ai enchaîné plusieurs projets et une première spécialisation —, je me consacre aujourd'hui à l'entraînement et à l'inférence de LLM à grande échelle sur clusters GPU. J'aime couvrir toute la chaîne : du benchmark bas niveau jusqu'au déploiement end-to-end. Je viens de terminer un stage de Research Analyst au Flatiron Institute (Simons Foundation) à New York, où j'ai travaillé sur le deep learning distribué (DDP, FSDP), les environnements HPC et le benchmarking GPU sur supercalculateurs. Ingénieur junior, bientôt diplômé (septembre 2026) de l'UTBM (France) et de l'UQAC (Canada) dans le cadre d'un double diplôme, spécialisé en IA.",
      en: "I got into machine learning through reinforcement learning — where I built several projects and first specialized — and now focus on training and serving LLMs at scale on GPU clusters. I like covering the whole chain: from low-level benchmarking to end-to-end deployment. I just finished a Research Analyst internship at the Flatiron Institute (Simons Foundation) in New York, where I worked on distributed deep learning (DDP, FSDP), HPC environments and GPU benchmarking on supercomputing systems. Junior engineer, soon graduating (September 2026) from UTBM (France) and UQAC (Canada) through a dual-degree program, specialized in AI.",
  },
...
export const studies = [
  {
    ...
    tags: ["Distributed", "PyTorch", "Multi-node", "B300"],
    accent: "from-sky-500 to-cyan-500",
    description: {
      fr: "Étude et benchmark de l'entraînement distribué avec Fully Sharded Data Parallel (FSDP), menés à grande échelle sur un cluster GPU multi-nœuds (jusqu'à 8 nœuds NVIDIA B300) : impact du sharding sur la mémoire et le débit.",
      en: "Study and benchmark of distributed training with Fully Sharded Data Parallel (FSDP), run at large scale on a multi-node GPU cluster (up to 8 NVIDIA B300 nodes): impact of sharding on memory footprint and throughput.",
    },
    link: "",
  },
  {
